...
public class TrainLogic {
	...
	public Train createTrain(String detinationPoint, int trainNumber, Date departureTime)
		...
		if (detinationPoint == null) {
			throw new IllegalArgumentException("detinationPoint не должен быть null");
		}

		if (trainNumber <= 0) {
			throw new IllegalArgumentException("trainNumber не должен быть 0");
		}

		if (departureTime == null) {
			throw new IllegalArgumentException("departureTime не должен быть null");
		}
